...
namespace textAdventure2
{
    class Program
    {
        ...
        {
            Console.WriteLine("Hey this in the beginning of LostLand The Text Based Rpg.");
        ...
        public static void first()
        {
            ...
            Console.WriteLine("You are lost in a forest with no cellphone reception and only a m1911 with 7 bullets,lighter,");
            Console.WriteLine("and some kindling");
            Console.WriteLine("What do you do?");
            Console.WriteLine("1. seek out help");
            Console.WriteLine("2. look for water");
            Console.WriteLine("3. Hunt For Food");
            ...
            switch (choice)
            {
                ...
                case "build a shelter":
                    {
                        Console.WriteLine("You find a deer.");
                        Console.WriteLine("You fire 3 of your bullets striking the deer in the lungs.");
                        Console.WriteLine("You start a fire and cook the meat.");
                        Console.ReadLine();
                        second();
                        break;
                    }
